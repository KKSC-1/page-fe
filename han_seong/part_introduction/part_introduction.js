...
/**
 * Complete this class:
 * 1- prev/next buttons must work
 * 2- load more slides when needed
 * 3- preload next image for faster display
 */
...
/**
 * Get slides from the slideshow API.
 * @param String id - The guid of the last slide we have.
 * @param Integer count - How many slides we want to fetch.
 */
